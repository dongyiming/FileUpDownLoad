package com.example.upload_file_ui.retrofit;

import com.example.upload_file_ui.IUploadProgress;
import com.example.upload_file_ui.interceptor.UploadInterceptor;
...
public class RetrofitBuilder {
    ...
    public Retrofit getRetrofit(IUploadProgress iUploadProgress) {

        UploadInterceptor uploadInterceptor = new UploadInterceptor(iUploadProgress);
